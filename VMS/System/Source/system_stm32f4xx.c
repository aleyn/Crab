...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F405xG)
...
//#define PLL_M      25
#define PLL_M      8
#elif defined (STM32F446xx) || defined (STM32F405xG)
#define PLL_M      8
...
#if defined(STM32F40_41xxx) || defined(STM32F405xG)
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) || defined(STM32F446xx) || defined(STM32F405xG)
      if (pllsource != 0)
      {
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F446xx)  || defined(STM32F405xG)   
    /* PCLK2 = HCLK / 2*/
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) || defined(STM32F405xG)   
...
/******************************************************************************/
  ...
  uint32_t tmp_m, tmp_n, tmp_p, tmp_q;
  ...
  tmp_p = PLL_P;
  tmp_q = PLL_Q;
  RCC->PLLCFGR = tmp_m | (tmp_n << 6) | (((tmp_p >> 1) -1) << 16) | (tmp_q << 24); 
